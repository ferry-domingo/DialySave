                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <div class="flex justify-between items-start mb-2">
                                        <h3 class="font-medium text-gray-900"><?php echo e($appointment->patient->full_name ?? 'Unknown Patient'); ?></h3>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    <?php echo e($appointment->patient->full_name ?? 'Unknown Patient'); ?></div>
                                            </div>
                                        </div>
                                    </td>
...
<?php endif; ?><?php /**PATH C:\laragon\www\DialySave\resources\views/patient/appointment.blade.php ENDPATH**/ ?>
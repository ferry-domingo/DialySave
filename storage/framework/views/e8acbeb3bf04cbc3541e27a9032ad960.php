    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
        <div class="max-w-2xl mx-auto px-4">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <!-- Form -->
                <form action="<?php echo e(route('sessions.store')); ?>" method="POST" class="px-8 py-8 space-y-6">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\DialySave\resources\views/admin/dialysis_session/createsession.blade.php ENDPATH**/ ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-xl shadow-xl p-10 mb-8 border border-gray-200" id="dialysisReport">
        ...
        <div class="border-b-3 border-blue-600 pb-6 mb-8">
          <div class="flex justify-between items-start">
            <div>
              ...
              <p class="text-gray-600 mt-2 text-lg">Or# <?php echo e($session->or_number); ?></p>
            </div>
            <div class="text-right">
              <p class="text-gray-600 text-lg">Date: <?php echo e(now()->format('F d, Y')); ?></p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div class="flex items-start">
                ...
                <span class="text-gray-800 text-lg"><?php echo e($session->patient->full_name); ?></span>
              </div>
              <div class="flex items-start">
                <span class="font-semibold text-gray-700 w-24">Age:</span>
                <span
                  class="text-gray-800 text-lg"><?php echo e(\Carbon\Carbon::parse($session->patient->birthdate)->age); ?></span>
              </div>
              <div class="flex items-start">
                <span class="font-semibold text-gray-700 w-24">Gender:</span>
                <span class="text-gray-800 text-lg"><?php echo e($session->patient->gender); ?></span>
              </div>
            </div>
            <div class="space-y-4">
              <div class="flex items-start">
                <span class="font-semibold text-gray-700 w-24">Contact:</span>
                <span class="text-gray-800 text-lg"><?php echo e($session->patient->contact_no); ?></span>
              </div>
              <div class="flex items-start">
                <span class="font-semibold text-gray-700 w-24">Blood Type:</span>
                <span class="text-gray-800 text-lg"><?php echo e($session->patient->blood_type); ?></span>
              </div>
              <div class="flex items-start">
                <span class="font-semibold text-gray-700 w-24">Medical Condition:</span>
                <span class="text-gray-800 text-lg"><?php echo e($session->patient->medical_conditions); ?></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mb-10">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <div class="bg-gradient-to-br from-red-50 to-red-100 p-5 rounded-xl shadow-sm border border-red-200">
              ...
              <div class="text-2xl font-bold text-red-800"><?php echo e($session->vital_sign->blood_pressure ?? ''); ?></div>
            ...
            <div class="bg-gradient-to-br from-pink-50 to-pink-100 p-5 rounded-xl shadow-sm border border-pink-200">
              ...
              <div class="text-2xl font-bold text-pink-800"><?php echo e($session->vital_sign->heart_rate ?? ''); ?></div>
            ...
            <div
              ...
              <div class="text-2xl font-bold text-orange-800"><?php echo e($session->vital_sign->temperature ?? ''); ?></div>
            ...
            <div class="bg-gradient-to-br from-teal-50 to-teal-100 p-5 rounded-xl shadow-sm border border-teal-200">
              ...
              <div class="text-2xl font-bold text-teal-800"><?php echo e($session->vital_sign->respiratory_rate ?? ''); ?></div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-xl shadow-sm border border-blue-200">
              ...
              <div class="text-2xl font-bold text-blue-800"><?php echo e($session->vital_sign->weight_before ?? ''); ?></div>
            ...
            <div
              ...
              <div class="text-2xl font-bold text-purple-800"><?php echo e($session->vital_sign->weight_after ?? ''); ?></div>
        ...
        <div class="mb-10">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div class="bg-gradient-to-br from-green-50 to-green-100 p-5 rounded-xl shadow-sm border border-green-200">
              ...
              <div class="text-2xl font-bold text-green-800"><?php echo e($session->lab_result->hemoglobin ?? ''); ?></div>
            ...
            <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 p-5 rounded-xl shadow-sm border border-cyan-200">
              ...
              <div class="text-2xl font-bold text-cyan-800"><?php echo e($session->lab_result->creatinine ?? ''); ?></div>
            ...
            <div
              ...
              <div class="text-2xl font-bold text-indigo-800"><?php echo e($session->lab_result->potassium ?? ''); ?></div>
            ...
            <div
              ...
              <div class="text-lg font-semibold text-yellow-800"><?php echo e($session->lab_result->remarks ?? ''); ?></div>
        ...
        <div class="border-t-2 border-gray-300 pt-6 text-center text-gray-600">
          ...
          <p class="text-sm">Report generated on <?php echo e(now()->format('F d, Y h:i A')); ?></p>
        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\DialySave\resources\views/admin/dialysis_session/showsession.blade.php ENDPATH**/ ?>
    ...
    <div class="max-w-3xl mx-auto mt-10 px-4">
        <!-- Header Section -->
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold mb-2">Add Lab Result</h2>
                    <p class="text-gray-300">Complete the form below to record new lab results</p>
                </div>
        ...
        <!-- Form Card -->
        <form action="<?php echo e(route('labs.store')); ?>" method="POST" class="bg-white rounded-xl shadow-lg overflow-hidden">
            <?php echo csrf_field(); ?>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="form-group">
                    ...
                    <textarea name="remarks" id="remarks" rows="4"
                              ...
                              class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 resize-none"></textarea>
                </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>All lab results are securely stored and comply with medical data protection standards</p>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\DialySave\resources\views/admin/labresult/createlabresult.blade.php ENDPATH**/ ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <!-- Form Body -->
                <form action="<?php echo e(route('patients.update', $patient->id)); ?>" method="POST" class="px-6 py-5">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="full_name" id="full_name" value="<?php echo e($patient->full_name); ?>"
                            ...
                            <div>
                                ...
                                <input type="date" name="birthdate" id="birthdate" value="<?php echo e($patient->birthdate); ?>"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                                    required>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="gender" id="gender"
                                    ...
                                    <option value="female" <?php echo e($patient->gender == 'female' ? 'selected' : ''); ?>>Female
                                    </option>
                                    <option value="other" <?php echo e($patient->gender == 'other' ? 'selected' : ''); ?>>Other
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="address" id="address" value="<?php echo e($patient->address); ?>"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                            ...
                            <div>
                                ...
                                <input type="text" name="contact_no" id="contact_no" value="<?php echo e($patient->contact_no); ?>"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                        ...
                        <div>
                            ...
                            <textarea name="medical_conditions" id="medical_conditions" rows="4"
                                class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                                placeholder="List any existing medical conditions, allergies, or medications"><?php echo e($patient->medical_conditions); ?></textarea>
                        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\DialySave\resources\views/admin/patients/editpatient.blade.php ENDPATH**/ ?>
    ...
    <div class="max-w-4xl mx-auto px-4 py-10">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-2">
                <h2 class="text-3xl font-bold text-gray-900">Record Vital Signs</h2>
                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                    Medical Session
                </span>
            </div>
            <p class="text-gray-600">Enter patient's vital measurements for current session</p>
        </div>

        <!-- Success Message -->
        <?php if(session('success')): ?>
            <div class="mb-8 p-4 rounded-lg border border-green-200 bg-gradient-to-r from-green-50 to-green-100 shadow-sm transition-all duration-300 transform hover:scale-[1.01]">
        ...
        <!-- Form Card -->
        <form action="<?php echo e(route('vitals.store')); ?>" method="POST" class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="session_id" value="<?php echo e($session->id); ?>" required>

            <!-- Form Header -->
            <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Patient Measurements</h3>
                <p class="text-sm text-gray-500 mt-1">All fields are required for accurate records</p>
            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\DialySave\resources\views/admin/vitalsigns/createvitalsign.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
    <form method="POST" action="<?php echo e(route('password.store')); ?>" class="max-w-md mx-auto w-full space-y-6 px-4 shadow-md py-4 sm:px-6">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\DialySave\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>
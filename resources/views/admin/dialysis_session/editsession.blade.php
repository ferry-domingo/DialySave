    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
        <div class="max-w-2xl mx-auto px-4">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <!-- Form -->
                <form action="{{ route('sessions.update', $session->id) }}" method="POST" class="px-8 py-8 space-y-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="relative">
                            <div class="flex">
                                <input 
                                    ...
                                    autocomplete="off"
                                    value="{{ $session->patient ? $session->patient->full_name : '' }}"
                                >
                                <button 
                                    type="button" 
                                    id="clear-search"
                            ...
                            <input type="hidden" name="patient_id" id="patient-id" value="{{ $session->patient_id }}">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select name="dialysis_type" id="dialysis_type"
                                ...
                                <option value="hemodialysis" {{ $session->dialysis_type === 'hemodialysis' ? 'selected' : '' }}>Hemodialysis</option>
                                <option value="peritoneal" {{ $session->dialysis_type === 'peritoneal' ? 'selected' : '' }}>Peritoneal</option>
                            </select>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="notes" id="notes" rows="3"
                            ...
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm hover:shadow-md resize-none">{{ $session->notes }}</textarea>

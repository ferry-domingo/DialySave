<aside class="flex flex-wrap flex-col w-48 h-screen px-4 py-8  bg-white border-r rtl:border-r-0 rtl:border-l ">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6 text-sm">
        <nav>
            ...
            <span class="mx-2 font-medium text-black ">{{Auth::user()->name}}</span>
            ...
            <a class="flex items-center px-4 py-2 mt-5  text-black  transition-colors duration-300 transform rounded-md  hover:bg-green-100"
                ...
                <span class="mx-4 font-medium">Dialysis Sessions</span>
            </a>
            ...
            <div class="hidden sm:flex sm:items-center ">
                <x-dropdown align="left" width="48">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center px-4 py-2 mt-5  text-black   transition-colors duration-300 transform rounded-md  hover:bg-green-100">
                            <svg class="w-5 h-5 text-yellow-500" viewBox="0 0 24 24" fill="none"

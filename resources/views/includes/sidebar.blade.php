<aside
    ...
    <div class="flex items-center">
        <a href="#">
            <img class="w-10 h-20 sm:h-7" src="/images/logo.png" alt="">
        </a>
    </div>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            <a href="{{route('profile.edit')}}" class="flex items-center px-4 -mx-2 my-5">
            ...
            <div class="grid justify-center">
                < <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-danger-button :href="route('logout')" onclick="event.preventDefault();
